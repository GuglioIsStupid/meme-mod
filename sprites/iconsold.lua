...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 450, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- new pico
		{x = 600, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- new pico
		{x = 750, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- new monster
		{x = 900, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0} -- new monster
	},
	{
		...
		["pico"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0},
		["pico losing"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
		...
		["monster"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
		["monster losing"] = {start = 27, stop = 27, speed = 0, offsetX = 0, offsetY = 0},
