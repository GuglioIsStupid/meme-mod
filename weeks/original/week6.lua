...
return {
	...
	initUI = function(self)
		...
		if song == 3 then
			weeksPixel:generateNotes(love.filesystem.load("charts/original/week6/thorns" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeksPixel:generateNotes(love.filesystem.load("charts/original/week6/roses" .. difficulty .. ".lua")())
		else
			weeksPixel:generateNotes(love.filesystem.load("charts/original/week6/senpai" .. difficulty .. ".lua")())
		end
	end,
