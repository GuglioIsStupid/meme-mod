...
return {
	enter = function(self, from, songNum, songAppend)
		...
		if song ~= 3 then
			...
			iphone = graphics.newImage(love.graphics.newImage(graphics.imagePath("monochrome/iphone")))
		...
		fakeBoyfriend = love.filesystem.load("sprites/boyfriendgold.lua")() -- Used for game over

		rating = love.filesystem.load("sprites/rating.lua")()

		girlfriend.x, girlfriend.y = -50, 410
		enemy.x, enemy.y = -780, 410
		iphone.x, iphone.y = -280, 310
		enemy.sizeX, enemy.sizeY = 1.7, 1.7
		boyfriend.x, boyfriend.y = -780, 3000 
		fakeBoyfriend.x, fakeBoyfriend.y = -780, 410
		fakeBoyfriend.sizeX, fakeBoyfriend.sizeY = 2, 2
		...
		enemyIcon = sprites.icons() --bitch i hate you and i hope you die oh wait you already did lmao dumbass
	...
	load = function(self)
		...
		elseif song == 2 then
			...
			inst = love.audio.newSource("music/week5/monochrome-inst.ogg", "stream")
			voices = love.audio.newSource("music/week5/monochrome-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		...
		elseif song == 2 then
			...
			weeks:generateNotes(love.filesystem.load("charts/week5/monochrome" .. difficulty .. ".lua")())
		end
	end,
	...
	draw = function(self)
		...
		if enemy:getAnimName() ~= "up alt" then
			love.graphics.push()
				love.graphics.translate(graphics.getWidth() / 2, graphics.getHeight() / 2) --i fucking hate you
				love.graphics.scale(0.7, 0.7)
				enemy.sizeX, enemy.sizeY = 2, 2
