...
return {
	enter = function(self, from, songNum, songAppend)
		...
		if song ~= 3 then
			walls = graphics.newImage(love.graphics.newImage(graphics.imagePath("original/week5/walls")))
			...
			topBop = love.filesystem.load("sprites/original/week5/top-bop.lua")()
			bottomBop = love.filesystem.load("sprites/original/week5/bottom-bop.lua")()
			santa = love.filesystem.load("sprites/original/week5/santa.lua")()
		...
		girlfriend = love.filesystem.load("sprites/original/week5/girlfriend.lua")()
		enemy = love.filesystem.load("sprites/original/week5/dearest-duo.lua")()
		boyfriend = love.filesystem.load("sprites/original/week5/boyfriend.lua")()
	...
	load = function(self)
		...
		if song == 3 then
			...
			walls = graphics.newImage(love.graphics.newImage(graphics.imagePath("original/week5/evil-bg")))
			christmasTree = graphics.newImage(love.graphics.newImage(graphics.imagePath("original/week5/evil-tree")))
			snow = graphics.newImage(love.graphics.newImage(graphics.imagePath("original/week5/evil-snow")))
			...
			enemy = love.filesystem.load("sprites/original/week5/monster.lua")()
		...
		elseif song == 2 then
			inst = love.audio.newSource("music/original/week5/eggnog-inst.ogg", "stream")
			voices = love.audio.newSource("music/original/week5/eggnog-voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/original/week5/cocoa-inst.ogg", "stream")
			voices = love.audio.newSource("music/original/week5/cocoa-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		...
		if song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/original/week5/winter-horrorland" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/original/week5/eggnog" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/original/week5/cocoa" .. difficulty .. ".lua")())
		end
	end,
