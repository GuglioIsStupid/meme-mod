...
local fard = love.audio.newSource("sounds/fard.ogg", "static")
...
return {
	...
	updateUI = function(self, dt)
		...
		if health > 100 then
			health = 100
		elseif health > 20 and boyfriendIcon:getAnimName() == "mommy mearest losing" then
			boyfriendIcon:animate("mommy mearest", false)
			enemyIcon:animate("monster losing", false)
		elseif health <= 0 then -- Game over
			Gamestate.push(gameOver)
		elseif health <= 20 and boyfriendIcon:getAnimName() == "mommy mearest" then
			boyfriendIcon:animate("mommy mearest losing", false)
