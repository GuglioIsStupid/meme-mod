...
local titleBG = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/weekMenu")))
...
tutorial = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week0")))
week1 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week1")))
week2 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week2")))
week3 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week3")))
week4 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week4")))
week5 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week5")))
week6 = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week6")))
weekg = graphics.newImage(love.graphics.newImage(graphics.imagePath("gMenu/storymenu/week7")))
		...
		function confirmFunc()
			...
			graphics.fadeOut(
				...
				function()
					...
					Gamestate.switch(weekDataG[weekNum], songNum, songAppend)
	...
	update = function(self, dt)
		...
		function menuFunc()
			...
			elseif weekNum == 8 then
				trackNames = "\nHeadache\nNerves\nRelease\nFading"
				menuDesc = "SMOKE 'EM OUT STRUGGLE"
			end
